...
def banner():
    print("""
   𝗘𝗟 𝗦𝗛𝗔𝗧𝗘𝗥 𝗔𝗡𝗗 𝗗𝗖 𝗩 𝗜 𝗥 𝗨 𝗦،"(💛🔐 ء╗""")
    sleep(0.50)
    print("   V I R U S & El ShaTeR")
    sleep(0.50)
    print("""   Qالشاطر  علاء و فيرس و بانون و سناره بنوقلك كسمك يا سبيديQ""")
    sleep(0.50)
    print("""     Q  كسم سبيدي علي كسم تيم سبيديQ""")
banner()
print("")
